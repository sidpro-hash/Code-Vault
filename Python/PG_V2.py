...
total_adhoc = mode_A + no_mode_A
total_non_PG = mode_B + no_mode_B
# year,month,day
EMI_received = mode_with_razorpay[mode_with_razorpay["EMI received date"]==pd.Timestamp(year,month,day)]["Loan Account number"]
no_mode_non_PG = pd.DataFrame({"Loan Account number":no_mode_without_razorpay["Loan Account number"],"Location":no_mode_without_razorpay["Location"],"Product Name":no_mode_without_razorpay["Product Name"],"Presentation Mode":no_mode_without_razorpay["Presentation Mode"]})
mode_non_PG = pd.DataFrame({"Loan Account number":mode_without_razorpay["Loan Account number"],"Location":mode_without_razorpay["Location"],"Product Name":mode_without_razorpay["Product Name"],"Presentation Mode":mode_without_razorpay["Presentation Mode"]})
...
no_mode_non_PG.to_excel("no_mode_non_PG.xlsx", sheet_name="Sheet1")
mode_non_PG.to_excel("mode_non_PG.xlsx",sheet_name="Sheet1")
